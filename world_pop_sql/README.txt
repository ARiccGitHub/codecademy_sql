...
Codecademy Data Science course SQL basic level section
...
Project map:
codecademy_sql\world_pop_sql\db.sqlite			SQLite database 
codecademy_sql\world_pop_sql\population_queries.sql	SQL queries code line file 
